...
#args_train_ee = \
    [ 
        ...
        #'--load-model', 'main_models/models/cifar10/egg19_bn/after_main_training/ee3/conv2/model.pt',
        #'--load-model', 'main_models/models/svhn/egg19_bn/after_main_training/ee3/conv2/model.pt',
        #'--load-model', 'main_models/models/cifar10/denseeenet121/after_main_training/ee3/conv2/model.pt',
        '--load-model', 'main_models/models/svhn/denseeenet121/after_main_training/ee3/conv2/model.pt',
        '--use-main-targets',
        #'--early-stopping',
        # '--plot-history',
        '--loss-func', 'v1',
